...
| qa-check | 2026-05-26 | 2026-05-31 | 38 | 38 | active | v1.1.0 → v1.2.0 (P3, 카테고리 11). Phase 1:8 + Phase 2:7 + Phase 3:6 + Phase 4:5 + Phase 4.5:1 + Phase 6:2 + Phase 5:2 + Phase 5.5:1 + Phase 7:1 + Phase 8:2 + Phase 9:1 + Phase 9.5:1 + **Phase M0:1** (Slice 1 entry — meta-phase 경량: 런타임 변경 0 + proposal-first + MVP 범위 위반 0 점검) |
