...
|---|---|---|
| AppShell | 지속 하단 탭 네비(홈/새 기획/내 brain) — ✅ **S2 최소 구현** (Phase 27, components/AppShell.tsx, root layout 배선, /login 숨김, 전 페이지 도달성). 데스크톱 좌측 사이드바 full 은 후속 deferred. | Dashboard, Workspace 전반 |
