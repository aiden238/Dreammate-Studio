...
| **11~20** | **서비스 안정화 / 배포 / LLM Gateway** | next | ★ **Phase 11 후보: LLM Gateway(A안 — cross-validation, meta/proposals/2026-05-31_llm-gateway-design.md §18.A)** / B안(3-provider 다양성)은 후속 phase 지침 §18.B + 배포 Gate B~G (staging→알파→베타→운영) + 4계층 linkage / SSE async worker / prompt A/B / 자동 promotion / 실 LLM eval default / M3 새 GAP 3(G9/G10/G11) |
