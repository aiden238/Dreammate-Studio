...
| **18** | **브랜딩 세션 (Akinator 주제발굴)** | **active** (entry 2026-06-04) | LLM 동적 스무고개(카드+자유입력) → 후보 주제 3×브랜딩 방향 → planning + brand_memory(PKM) 시드. ★ 발굴→축적→주입 루프 결합. 근거: `meta/proposals/2026-06-04_branding-session-akinator-design.md` |
